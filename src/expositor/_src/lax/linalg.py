...
from expositor._src.numpy import lax_numpy as jnp
from expositor._src.numpy.vectorize import vectorize
from expositor import ad_util
from expositor._src import api
from expositor import lax
from expositor import ops
from expositor._src import dtypes
from expositor.interpreters import xla
from expositor.interpreters import ad
from expositor.interpreters import batching
from expositor._src.util import partial, prod
from expositor.core import Primitive, ShapedArray, raise_to_shaped
from expositor._src.lax.lax import (
    standard_primitive, standard_unop, naryop_dtype_rule, _float, _complex,
    _input_dtype, _broadcasting_select)
from expositor._src.lax import lax as lax_internal
from expositor.lib import lapack

from expositor.lib import cuda_linalg
from expositor.lib import cusolver
from expositor.lib import rocsolver

from expositor.lib import xla_client
from expositor.lib import xla_bridge as xb
...
def eig_jvp_rule(primals, tangents, *, compute_left_eigenvectors,
  ...
  if compute_left_eigenvectors or compute_right_eigenvectors:
    raise NotImplementedError(
        ...
        'eigenvalues. See '
        'https://github.com/google/expositor/issues/2748 for discussion.')
...
def _lu_unblocked(a):
  ...
  if m == 0 and n == 0:
    ...
    # expositorpr fails because the indexing cannot succeed.
    return (pivot, perm, a)
